...
/*   Updated: 2021/11/15 20:19:41 by mbistami         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	int		string;
	char	dest[4] = "";
	char 	*src = (char *)"thx to ntoniolo for this test !";

	//ft_strlcat(dest, src, sizeof(char));
	printf("%zu %s", strlcat(dest, src, ft_strlen(src)), dest);
}
